    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            <div className='slider-img'>
                <img src={image} alt="" className="w-[1140px] h-full rounded-xl" />
            </div>
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-24 top-1/2 w-1/2">
            ...
            <div className="absolute transform -translate-y-1/2 left-24 top-3/4 w-1/2">
